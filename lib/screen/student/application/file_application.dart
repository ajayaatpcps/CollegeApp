          ...
          data: Theme.of(context).copyWith(
            ...
            textButtonTheme: TextButtonThemeData(
              style: TextButton.styleFrom(
                foregroundColor: Colors.blue, // OK & Cancel button color
              ),
            ),
          ),
          child: child!,
                ...
                child: Column(
                  ...
                  children: [
                    LeaveDropdown(
                      ...
                      wid: size.width,
                      onChanged: (value) =>
                          setState(() => applicationType = value),
                    ),
                    ...
                    CustomButton(
                      ...
                      onPressed: () async {
                        ...
                        final check = await Provider.of<ApplicationViewModel>(
                                context,
                                listen: false)
