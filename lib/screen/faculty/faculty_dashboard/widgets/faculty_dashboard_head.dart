...
import '../../../student/calender/calender.dart';
import '../../../student/download_forums/download_forums.dart';
import 'faculty_dashboard_card.dart';

class FacultyDashboardHead extends StatefulWidget {
  const FacultyDashboardHead({
    super.key,
  });
  @override
  State<FacultyDashboardHead> createState() => _FacultyDashboardHeadState();
}

class _FacultyDashboardHeadState extends State<FacultyDashboardHead> {
  ...
  final List<Map<String, dynamic>> allCards = [
    ...
    {'text': 'Breo', 'icon': Icons.web, 'link': 'https://breo.beds.ac.uk/'},
    {
      'text': 'E-library',
      'icon': Icons.book,
      'link': 'https://elibrary.patancollege.edu.np/'
    },
    {
      'text': 'Calendar',
    ...
    },
    {
      ...
      'icon': Icons.lock,
      'className': const ChangePassword()
    },
  ];
              ...
              Consumer<UserDataViewModel>(
                builder: (context, userDataViewModel, child) {
                  ...
                  if (userDataViewModel.isLoading) {
                    ...
                    String? name = getFirstWordsOrShrink("Faculty");
                    return Positioned(
                      bottom: 90,
                      left: 20,
                      child: Text(
